...
ALTER TABLE Supplier MODIFY COLUMN address VARCHAR(500) CHARACTER SET utf8mb4;
ALTER TABLE Supplier ADD COLUMN appleId VARCHAR(500) CHARACTER SET utf8mb4;
ALTER TABLE Supplier MODIFY COLUMN appleId VARCHAR(500) CHARACTER SET utf8mb4 DEFAULT '';
